...
namespace Fast_Start
{
    class Colodka
    {
        ...
        public Colodka(double _lenght, double _width, int _step, int _distanse_for_start_line, int _hight, int _width_plastin, int _alfa1, int _alfa2, bool _rubber_pads, double _distanse )
        {
            lenght = _lenght;
            width = _width;
            step = _step;
